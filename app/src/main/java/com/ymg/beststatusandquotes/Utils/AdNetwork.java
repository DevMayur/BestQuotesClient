        ...
        if (adsPref.getAdStatus().equals(AD_STATUS_ON) && ad_placement != 0) {
            switch (adsPref.getAdType()) {
                ...
                case APPLOVIN:
                    ...
                    maxAdView.setBackgroundColor(context.getResources().getColor(R.color.bgMain));
        ...
        if (adsPref.getAdStatus().equals(AD_STATUS_ON) && ad_placement != 0) {
            switch (adsPref.getAdType()) {
                case ADMOB:
                    ...
                    break;
                case FAN: //This app is Created by YMG-developers
                ...
                case STARTAPP:
                    ...
                    break;
                case APPLOVIN: //This app is Created by YMG-developers
                        ...
                        AdLoader adLoader = new AdLoader.Builder(context, adsPref.getAdMobNativeId())
                                .forNativeAd(NativeAd -> {
                                    if (sharedPref.loadNightModeState()) {
                                        ColorDrawable colorDrawable = new ColorDrawable(ContextCompat.getColor(context, R.color.bgMain));
                                        NativeTemplateStyle styles = new NativeTemplateStyle.Builder().withMainBackgroundColor(colorDrawable).build();
                                        admob_native_ad.setStyles(styles);
                                        admob_native_background.setBackgroundResource(R.color.bgMain);
                                    } else {
                                        ColorDrawable colorDrawable = new ColorDrawable(ContextCompat.getColor(context, R.color.bgMain));
                                        NativeTemplateStyle styles = new NativeTemplateStyle.Builder().withMainBackgroundColor(colorDrawable).build();
                                        admob_native_ad.setStyles(styles);
                    ...
                    if (fan_native_ad.getVisibility() != View.VISIBLE) {
                        ...
                        NativeAdListener nativeAdListener = new NativeAdListener() {
                            ...
                            public void onAdLoaded(Ad ad) {
                                ...
                                if (sharedPref.loadNightModeState()) {
                                    fan_native_background.setBackgroundResource(R.color.bgMain);
                                } else {
                                    fan_native_background.setBackgroundResource(R.color.bgMain);
                                }
                    ...
                    if (startapp_native_ad.getVisibility() != View.VISIBLE) {
                        ...
                        AdEventListener adListener = new AdEventListener() {
                            ...
                            public void onReceiveAd(com.startapp.sdk.adsbase.Ad arg0) {
                                ...
                                if (sharedPref.loadNightModeState()) {
                                    startapp_native_background.setBackgroundResource(R.color.bgMain);
                                } else {
                                    startapp_native_background.setBackgroundResource(R.color.bgMain);
                                }
